"""Every nucleus/mutants_*.py still POINTS AT SOMETHING REAL — the interim ratchet.
...
Run: venv/bin/python nucleus/test_mutants_wellformed.py   (also wired into nucleus/check.sh)
"""
...
if __name__ == "__main__":
    files = mutants_files()
    if not files:
        print("SKIP: no nucleus/mutants_*.py present — nothing was verified here.")
        sys.exit(EXIT_SKIP)
